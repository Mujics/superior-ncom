...
public class FuncionesCosenoController {
    ...
    public ModelAndView calcular(@RequestParam Map<String,String> allParams) {
        String formula = "";
        FuncionTrigonometrica funcionTrigonometrica1 = new FuncionTrigonometrica(allParams.get("amplitud1"), allParams.get("frecuencia1"), allParams.get("fase1"));
        FuncionTrigonometrica funcionTrigonometrica2 = new FuncionTrigonometrica(allParams.get("amplitud2"), allParams.get("frecuencia2"), allParams.get("fase2"));
        formula += funcionTrigonometrica1.mostrar() + " + " + funcionTrigonometrica2.mostrar() + " = ";
