...
import superior.ncom.FuncionTrigonometricaFactory;
...
public class FuncionesCosenoController {
    ...
    public ModelAndView calcular(@RequestParam Map<String,String> allParams) {
        ...
        FuncionTrigonometrica funcionTrigonometrica1 = FuncionTrigonometricaFactory.create(allParams.get("amplitud1"), allParams.get("frecuencia1"), allParams.get("fase1"), allParams.get("tipo1"));
        FuncionTrigonometrica funcionTrigonometrica2 = FuncionTrigonometricaFactory.create(allParams.get("amplitud2"), allParams.get("frecuencia2"), allParams.get("fase2"), allParams.get("tipo2"));
